...
class TestBusinessMetrics:
    ...
    def test_export_metrics(self):
        ...
        # Add test data
        results = {'success': True, 'total_results': 5, 'chinese_results': 3, 
                  'zhihu_results': 1, 'engines_used': ['Bing'], 'results': []}
...
async def test_integration_mock(mock_get):
    ...
    mock_response.text = Mock(return_value=asyncio.coroutine(lambda: '<html><div class="b_algo"><h2>Test Title</h2><p>Test description</p></div></html>')())
